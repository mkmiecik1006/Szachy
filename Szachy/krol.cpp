        ...
        if(x!=x2||y!=y2) //ruszamy się gdzieś
        {
            ...
            else if(pierwszy==false && x==2 && y2==y)       //roszada
            {
                ...
                if(b->czypierwszy()==false)
                {
                    ...
                    {
                        if(((szach(pozycja, s)!=0 && szach(p1, s)!=0 )&& szach(p2, s)!=0) && szach(p3, s)!=0) //król i pola przez które przejdzie nie są szachowane
                        {
            ...
            else if(pierwszy== false && x==6&& pozycja[1]==y)
            {
                ...
                if(b->czypierwszy()==false)
                {
                    ...
                    {
                        if((szach(pozycja, s)!=0&& szach(p1, s))!=0&&szach(p2, s)!=0) //król i pola przez które przejdzie nie są szachowane
                        {
